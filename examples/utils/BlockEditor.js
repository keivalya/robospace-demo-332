// BlockEditor.js — Dual-Mode Blockly Visual Editor for RoboSpace
...
export class BlockEditor {
    ...
    initCustomBlocks() {
        ...
        const blockDefs = [
            {
                ...
                "args0": [
                    ...
                    { "type": "field_number", "name": "Z", "value": 0.3, "precision": 0.01 }
                ],
        ...
        // Compatible with both Blockly v9+ (Blockly.Python.forBlock or python.pythonGenerator) and classic Blockly.Python
